...
urlpatterns = [
	...
	path('ws/banda/',ws_banda_vista, name= 'ws_banda_vista'),
	path('ws/integrante/',ws_integrante_vista, name= 'ws_integrante_vista'),
	path('ws/rol/',ws_rol_vista, name= 'ws_rol_vista'),
	path('ws/nacionalidad/',ws_nacionalidad_vista, name= 'ws_nacionalidad_vista'),
